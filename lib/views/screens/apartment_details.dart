...
class _ApartmentDetailsState extends State<ApartmentDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final isTokenExpired = tokenProvider.isTokenExpired ?? true;
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: isTokenExpired
              ? Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text("Please login to proceed booking"),
                    SizedBox(
                      width: Dimensions.width300,
                      child: ElevatedButton(
                        style: const ButtonStyle(
                          backgroundColor: WidgetStatePropertyAll(customSwatch),
